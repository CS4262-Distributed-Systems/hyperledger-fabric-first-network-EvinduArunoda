...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Take an asset id and an owner, duplicate the asset and assign the duplicate
     * to the new owner while keeping the original asset with the previous original
     * owner.
     *
     * @param ctx               the transaction context
     * @param assetID           ID of the original Asset
     * @param owner             Owner of the duplicated Asset
     * @param duplicatedAssetID ID of the duplicated Asset
     */
    @Transaction(intent = Transaction.TYPE.SUBMIT)
    public Asset DuplicateAsset(final Context ctx, final String assetID, final String owner,
            final String duplicatedAssetID) {
        ChaincodeStub stub = ctx.getStub();
        ...
        Asset duplicate = new Asset(duplicatedAssetID, oldAsset.getColor(), oldAsset.getSize(), owner,
                oldAsset.getAppraisedValue());

        String sortedJson = genson.serialize(duplicate);
